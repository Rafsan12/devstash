...
export function DashboardShell({
  ...
  return (
    <EditorPreferencesProvider initialPreferences={initialEditorPreferences}>
      <>
        <main className="min-h-screen bg-[radial-gradient(circle_at_top,rgba(56,189,248,0.12),transparent_28%),linear-gradient(180deg,#09090b_0%,#050507_100%)] text-white">
                    ...
                    <div className="flex-1 space-y-6 overflow-y-auto px-4 py-5">
                      ...
                      >
                        {sidebarItemTypes.map(itemType => (
                          <Link
                            className={cn(
                              'flex items-center gap-3 rounded-2xl px-3 py-3 text-sm transition hover:bg-white/5 hover:text-white',
                              'justify-between',
                          ...
                          >
                            <div className="flex items-center gap-3 overflow-hidden">
                              <span className="flex h-8 w-8 shrink-0 items-center justify-center rounded-xl border border-white/10 bg-white/3 text-sky-200">
                      ...
                      >
                        ...
                        >
                          <div className="flex items-center gap-3 overflow-hidden">
                            <span className="flex h-8 w-8 shrink-0 items-center justify-center rounded-xl border border-white/10 bg-white/3 text-xs font-semibold text-zinc-200">
                              ALL
                            </span>
                            <span
                              className={cn(
                      ...
                      <div className="flex flex-1 flex-col gap-3 lg:max-w-3xl lg:flex-row lg:items-center lg:justify-end">
                        <div className="relative lg:w-full lg:max-w-xl">
                          <button
                            ...
                            className="flex w-full cursor-pointer items-center gap-3 rounded-xl border border-white/10 bg-white/3 px-4 py-2.5 text-left text-sm text-zinc-500 transition hover:border-white/20 hover:bg-white/6 hover:text-zinc-400"
                            type="button"
...
function CollectionListItem({
  ...
  const leadingBadge =
    variant === 'favorite' ? (
      <span className="flex h-8 w-8 shrink-0 items-center justify-center rounded-xl border border-white/10 bg-white/3 text-xs font-semibold text-amber-200">
        STAR
      </span>
    ) : (
      <span
  ...
  return (
    ...
    >
      ...
      {variant === 'favorite' ? (
        <span
          className={cn('text-amber-300', isDesktopCollapsed && 'lg:hidden')}
        >
          *
        </span>
      ) : null}
