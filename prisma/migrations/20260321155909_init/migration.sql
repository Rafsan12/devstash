...
-- CreateIndex
CREATE UNIQUE INDEX "RecentItem_userId_itemId_key" ON "RecentItem"("userId", "itemId");
...
-- AddForeignKey
ALTER TABLE "RecentItem" ADD CONSTRAINT "RecentItem_itemId_fkey" FOREIGN KEY ("itemId") REFERENCES "Item"("id") ON DELETE CASCADE ON UPDATE CASCADE;
